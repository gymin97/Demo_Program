            ...
            if faces is not None:
                for i in range(person_num):
                    ...
                    if (mask_on is False) & (p_size > 0.3):
                        ...
                        cv2.putText(frame, '%d'%int(age[0]), (box[2] + 10, box[1] + 20), font, font_size_cv, (0, 0, 0), 5)
                        cv2.putText(frame, '%d'%int(age[0]), (box[2] + 10, box[1] + 20), font, font_size_cv, (255, 255, 255), 2)
                    ...
                    cv2.putText(frame, text, (box[0], box[1] - 5), font, font_size_cv, color, 2)
